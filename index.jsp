    ...
    <ul>
      ...
      <div class="tp-static-layers">
        ...
        <div class="tp-caption tp-static-layer" 
          ...
          data-startslide="0" 
          data-endslide="5" 
          style="z-index: 5;"><a href="#." class="btn-white border_radius uppercase">导出为表格</a>
        </div>
      </div>
    </ul>
  </div>
...
<div class="tp_overlay">
  <div class="topbar clearfix text-center">
    <ul class="breadcrumb_top">
      <li><a href="javascript:void(40)"><i class="icon-icons43"></i>Favorites</a></li>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <input type="text" class="v_name" placeholder="名字">
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
          <input type="text" class="v_address" placeholder="地址">
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
             <input type="text" class="v_wechat" placeholder="微信">
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
             <input type="text" class="v_qq" placeholder="QQ">
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
             <input type="text" class="v_phone" placeholder="电话">
          </div>
        </div>
      </div>
      <div class="col-sm-6">

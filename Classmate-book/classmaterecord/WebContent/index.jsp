    ...
    <ul>
      ...
      <div class="tp-static-layers">
        ...
        <div class="tp-caption tp-static-layer" 
          ...
          data-startslide="0" 
          data-endslide="5" 
          style="z-index: 5;"><a href="#." class="btn-white border_radius uppercase">show on the map</a>
        </div>
      </div>
    </ul>
  </div>
...
<div class="tp_overlay">
  ...
  <form class="callus top30 clearfix centered" method="post" action="Insert.java" >
  <h2 class="text-uppercase t_white bottom20 text-center">advanced search</h2>
    <div class="row">
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <input type="text" class="v_name" placeholder="name">
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
          <input type="text" class="v_address" placeholder="v_address">
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
             <input type="text" class="v_wechat" placeholder="v_wechat">
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
             <input type="text" class="v_qq" placeholder="v_qq">
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
             <input type="text" class="v_phone" placeholder="v_phone">
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="single-query bottom15">
          <div class="intro">
            <select>
              <option class="active">class</option>
              <option>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
    ...
    <div class="row">
      <div class="col-md-8 col-sm-8 col-xs-8 bottom15">
        <div class="single-query-slider">
          ...
          <div data-range_min="1958" data-range_max="2018" data-cur_min="1958" data-cur_max="2018" class="nstSlider">
            <div class="bar"></div>

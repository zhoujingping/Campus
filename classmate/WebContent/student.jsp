...
<script>
    function go() {
        ...
        console.log(s);
        //实现页面之间的跳转和URL传递参数
        window.location.href = "edit.jsp?s="+s;
    }
</script>
<script>
    function go1() {
        ...
        console.log(s);
        //实现页面之间的跳转和URL传递参数
        window.location.href = "delete.jsp?s="+s;
    }
</script>
...
<section id="property" class="padding bg_gallery">
  <div class="container">
    ...
    <c:forEach items="${requestScope.list}" var="list" varStatus="id">
        ...
        <div class="property_item">
          <div class="image">
            ...
            <div class="price clearfix"> 
              <span class="tag pull-right" name="i_id">${list.i_id}</span>
            </div>
            <form method="post" name="delete"  action="delete.jsp">
            <input type="hidden" name="s" value="${list.i_id}">
            <input class="tag_l" type="submit" value="删除">
            </form>
             <form method="post" name="edit"  action="edit.jsp">
              <input type="hidden" name="s" value="${list.i_id}">
            <input class="tag_t" type="submit" value="编辑">
            </form>
          </div>
          <div class="proerty_content">
            <div class="proerty_text">
              <h3 class="captlize" name="v_name">${list.v_name}</h3>
              <p>班级:${list.i_class}</p>
            </div>
